...
<div class="main_white_heading" style="margin: 30px 0px 10px; padding: 0px 0px 5px; border-width: 0px 0px 1px; border-bottom-style: dotted;width: 590px; border-bottom-color: #939393; outline: 0px; font-size: 18px; font-family: Arial, Helvetica, sans-serif; color: #133e1c; font-weight: bold; line-height: 17px; background-color: #ffffff;">MASTER TRAINERS</div>

<div class="select_trainer" style="width: 590px; margin: 0px; padding: 0px; border: 0px; outline: 0px; font-size: 12.222222328186035px; color: #000000; font-family: Arial, Helvetica, sans-serif; line-height: 17px; background-color: #ffffff;"><span style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-size: 10pt; font-weight: bold; font-family: Arial;"> <a style="margin: 0px; padding: 0px; border: 0px; outline: 0px; color: #133e1c;" href="http://taichi.wpengine.com/2014/01/28/what-is-a-master-trainer-mt/">What are the requirements?</a></span></div>

<p style="width: 590px; margin: 5px 0px; padding: 0px 0px 10px; border: 0px; outline: 0px; font-size: 12.222222328186035px; font-family: Arial, Helvetica, sans-serif; line-height: 17px; color: #000000; background-color: #ffffff;"><span style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-size: 10pt; font-family: Arial;">An MT is a person who is trained and authorised by Dr Paul Lam to conduct Tai Chi for Health Instructor  Workshops.  MTs are dedicated in promoting the Tai Chi for Health programs to enhance peoples' health and wellbeing. Click <a style="margin: 0px; padding: 0px; border: 0px; outline: 0px; color: #133e1c;" href="http://taichi.wpengine.com/2014/01/28/what-is-a-master-trainer-mt/">here</a> for more information about MTs and how to become one.</span></p><hr style = "width: 590px">
...
WHERE group_id = 5 and wp_Instructors_Certification.certification_expiry_date > curdate() 
    		   ";
...
<thead>
<tr>
<th>Master Trainer</th><th>State</th><th>Suburb</th><th>Qualifications</th><th hidden>country</th>
</tr>
</thead>
<tbody>
<?php
...
{	if($cert_obj['name'] == null || $cert_obj['name'] == '')
		continue;						
