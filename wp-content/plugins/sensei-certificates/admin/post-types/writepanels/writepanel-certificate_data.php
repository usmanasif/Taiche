...
function certificate_template_data_meta_box( $post ) {
	...
	global $woocommerce, $woothemes_sensei_certificate_templates, $wpdb;
...
{
$queryy = "
    					SELECT * FROM `wp_posts` WHERE `post_type` = 'tribe_events' and post_author =".$user_id;
...
$queryy = "
						...
						$Master_orders = $wpdb->get_results($queryy, OBJECT);
						foreach($Master_orders as $m_o)
						$m_orders[''.$m_o->post_title.''] = $m_o->post_title;
			...
			<?php
				...
				echo '<div class="options_group">';
					certificate_templates_wp_font_select( array(
						'id'                => '_certificate',
						'label'             => __( 'Select Font', 'sensei-certificates' ),
