...
<table class="form-table">
    ...
    <?php 
        $this->add_plugin_setting(
                ...
                __('Use WP Cron', 'upme'),
                '1',
                __('If checked, UPME will use WP Cron Feature to update User Search Cache.<br />Just make sure <code>DISABLE_WP_CRON</code> is not set to <code>TRUE</code> in <code>wp-config.php</code>', 'upme'),
                __('If checked, UPME will use WP Cron Feature to update User Search Cache.', 'upme')
        );
        ...
        $this->add_plugin_setting(
                ...
                __('Select whether to display the admin bar on frontend.', 'upme'),
                __('Select whether to display the admin bar on frontend.', 'upme')
        );
    ?>
    ...
    <?php
                ...
                $this->add_plugin_setting(
                        ...
                        array(
                            1 => __('User ID', 'upme'),
                            2 => __('Username', 'upme')),
                        __('You can choose to use the User ID or Username for profile URL permalinks.', 'upme'),
                        __('User ID will create profile permalinks without the username. Choose Username if you want to create profile permalinks using usernames.', 'upme')
                );
