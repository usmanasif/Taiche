...
class MC_OAuth2Client extends OAuth2Client {
    ...
    public function __construct() {
        ...
        $base = '127.0.0.1';   //your host
        $path = '/wp-admin/admin.php?page=taichi-admin-mc-settings'; //the path on your host

        $client_id = '356538669625';   //client_id from creating app in MC (see README)
        $client_secret = '9ce52013bc91e66325588ea8ddb9ef6d'; //client_secret from creating app in MC  (see README)
    ...
    public function refreshToken() {
        ...
        if (!$orig_data['oauth']['refresh_token'])
            throw new OAuth2Exception(array('Invalid refresh token, please re-authorize your account'));
        $params = array(
