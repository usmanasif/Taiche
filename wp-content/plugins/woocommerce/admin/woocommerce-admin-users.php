...
$admin = new WP_User(get_current_user_id());
			...
			foreach( $fieldset['fields'] as $key => $field ) :
				...
				<tr>
					...
					<td>
						<input <?php echo $disabled; ?> type="text" name="<?php echo esc_attr( $key ); ?>" id="<?php echo esc_attr( $key ); ?>" value="<?php echo esc_attr( get_user_meta( $user->ID, $key, true ) ); ?>" class="regular-text" /><br/>
